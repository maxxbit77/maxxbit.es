<template>
	<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
		<linearGradient
			id="yZ9i2phoZR7eklcnu190ua_me9baOv8L5z9_gr1"
			x1="32"
			x2="32"
			y1="540"
			y2="592"
		...
		<path
			fill="url(#yZ9i2phoZR7eklcnu190ua_me9baOv8L5z9_gr1)"
			d="M32,58C17.7,58,6,46.3,6,32S17.7,6,32,6s26,11.7,26,26S46.3,58,32,58z M32,8C18.8,8,8,18.8,8,32s10.8,24,24,24	s24-10.8,24-24S45.2,8,32,8z"
		></path>
		<linearGradient
			id="yZ9i2phoZR7eklcnu190ub_me9baOv8L5z9_gr2"
			x1="41.568"
			x2="41.568"
			y1="36.091"
			y2="33.937"
		...
		<path
			fill="url(#yZ9i2phoZR7eklcnu190ub_me9baOv8L5z9_gr2)"
			d="M41.5,29.9c-0.3,0-0.4,0.4-0.4,0.7c0,0.6,0.3,1.1,0.6,1.5c0.1-0.4,0.2-0.8,0.2-1.1C42,30.2,41.7,29.9,41.5,29.9	z"
		></path>
		<linearGradient
			id="yZ9i2phoZR7eklcnu190uc_me9baOv8L5z9_gr3"
			x1="32"
			x2="32"
			y1="56"
			y2="12"
