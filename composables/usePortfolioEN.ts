	...
	const experience = {
		...
		list: [
			...
			},
			{
				...
				position: 'Front end Developer',
				description:
					'A fully configurable starter template aimed at entrepreneurs looking to quickly launch a landing page. The template featured a modular component system, allowing users to add or remove sections effortlessly. It also integrated a wide range of third-party libraries, enabling users to customize their setup from a single configuration file, streamlining the development process.',
				responsibilities: [
					'Integrated libraries for error handling, multiple payment gateways, analytics, and more.',
					'Created native and dynamic components.',
					'Developed a Nuxt playground for template deployment.',
					'Implemented a centralized architecture using composables.',
			...
			},
			{
				...
				responsibilities: [
					'Developed the team creation interface with drag-and-drop functionality.',
					'Built the website with Web3 integration for user management.',
					'Collaborated on the development of the real-time combat system using WebSockets.',
					'Assisted in the development of the token-based payment system.',
					'Implemented UI/UX optimizations to enhance player experience.',
					'Integrated NFT smart contract interactions for card ownership and trading.',
				],
		...
		list: [
			{
				...
				position: '',
				description:
					'App training for Web3 integrations and smart contracts. A finance management application that helps users track their bank accounts, cash, investments, and cryptocurrencies. It provides a clear overview of their financial status with interactive charts and real-time market data.',
			...
			},
			{
				...
				endsAt: 'Now',
				description:
					'App training for DDD and hexagonal architecture. In this app, users will be able to share their mood on a map using emotes, explore global emotions in real time, and connect through a shared emotional experience.',
